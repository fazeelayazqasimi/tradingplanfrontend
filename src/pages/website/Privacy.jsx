...
export default function Privacy() {
  return (
    <div>
      <section className="bg-gradient-to-br from-dark-900 to-primary-900 text-white py-20"><div className="max-w-7xl mx-auto px-4"><motion.h1 initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-4xl font-bold">Privacy Policy</motion.h1></div></section>
