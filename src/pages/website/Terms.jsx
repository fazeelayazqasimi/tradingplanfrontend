...
export default function Terms() {
  return (
    <div>
      <section className="bg-gradient-to-br from-dark-900 to-primary-900 text-white py-20"><div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"><motion.h1 initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-3xl sm:text-4xl font-bold">Terms & Conditions</motion.h1></div></section>
      <section className="py-16"><div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose"><p className="text-dark-600">Last updated: January 2025</p>
        <h2>Acceptance of Terms</h2><p className="text-dark-600">By accessing this platform, you agree to be bound by these Terms & Conditions.</p>
