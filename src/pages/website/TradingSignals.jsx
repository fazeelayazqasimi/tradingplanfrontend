  ...
  return (
    <div>
        ...
        <div className="max-w-[1240px] mx-auto px-8">
          <ScrollReveal>
            <div className="text-center mb-14">
              ...
              <h2 className="text-[32px] font-extrabold" style={{ fontFamily: '"Plus Jakarta Sans"', letterSpacing: '-0.02em' }}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-12 border-t border-b border-dark-100">
            {content.stats.map((s, i) => (
              <ScrollReveal key={i} delay={i * 100}>
                <div className="text-center">
                  <div className="text-[34px] font-extrabold" style={{ fontFamily: '"Plus Jakarta Sans"' }}>{s.num}</div>
      ...
      <section className="section">
        <div className="max-w-[1240px] mx-auto px-8">
          <ScrollReveal>
            <div className="rounded-[26px] border border-dark-100 py-16 px-16 text-center" style={{ background: 'linear-gradient(120deg, #EFF4FE, #ECFDF5)' }}>
              <h3 className="text-[28px] mb-2.5" style={{ fontFamily: '"Plus Jakarta Sans"' }}>Start Receiving Signals Today</h3>
