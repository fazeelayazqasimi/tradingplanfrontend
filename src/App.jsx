...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'classes/physical', element: <StudentClasses /> },
      { path: 'classes/online', element: <StudentClasses /> },
      { path: 'classes/schedule', element: <StudentClasses /> },
      { path: 'study-material', element: <StudentClasses /> },
      { path: 'recordings', element: <StudentClasses /> },
