...
const adminService = {
  ...
  uploadAnnouncementImage: (formData) => unwrap(api.post('/announcements/upload-image', formData, { headers: { 'Content-Type': 'multipart/form-data' } })),
  uploadAnnouncementPdf: (formData) => unwrap(api.post('/announcements/upload-pdf', formData, { headers: { 'Content-Type': 'multipart/form-data' } })),
  uploadAnnouncementVideo: (formData) => unwrap(api.post('/announcements/upload-video', formData, { headers: { 'Content-Type': 'multipart/form-data' } })),
  getBusinessProfiles: (params) => unwrap(api.get('/business-profiles', { params })),
  createBusinessProfile: (data) => unwrap(api.post('/business-profiles', data)),
